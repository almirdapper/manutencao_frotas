...
public class ListaUsuarios extends javax.swing.JFrame {
    ...
    Factory.FacFuncionarios facFuncionarios = new Factory.FacFuncionarios();
    ArrayList<Funcioario> dadosFunconarios = new ArrayList<Funcioario>();
    int idInterface = 0;
    ...
    private void initComponents() {
        ...
        jTextArea1.setBorder(javax.swing.BorderFactory.createTitledBorder("Lista de Usuários Cadastrados:"));
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        for(Funcioario f: dadosFunconarios){
            jTextArea1.append("ID Usuário: "+f.getIdUsuario()+"\n"+
                              "Nome do Usuário: "+f.getNomeUsuario()+"\n"+
                              "Situação Do Usuário: "+f.getSituacao()+"\n"+
                               "Função Exercidada: "+f.getFuncao()+"\n"+
                               "Login: "+ f.getLogin()+"\n"+
